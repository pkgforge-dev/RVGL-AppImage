...
# Deploy dependencies
quick-sharun ./AppDir/bin/* /usr/lib/7zip/* /usr/lib/libSDL2_image-2.0.so.0 /usr/lib/libSDL2-2.0.so.0 /usr/lib/libenet.so.7 /usr/lib/libopenal.so.1 /usr/lib/libunistring.so.2 /usr/bin/env
